...
const guiManager = () => {
	...
	function fillDailyStats(data) {
		...
		const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(time_string, "yyyy-MM-dd HH:mm", new Date());
		const formatted_time = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(date, "HH:mm");
