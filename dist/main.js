...
const guiManager = () => {
	...
	function addSearchDiv(container) {
		...
		const buttonC = (0,_utility_js__WEBPACK_IMPORTED_MODULE_0__.createButton)("temp_button_c", "Celcius");
	...
	function fillDailyStats(data) {
		...
		const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(time_string, "yyyy-MM-dd HH:mm", new Date());
		const formatted_time = (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(date, "h:mm a");
